...
RES="$PATH_TO_SDL3/RetroPPCAPPL.r $PATH_TO_SDL3/SDL.r"
...
#cp $1.pef $1.APPL
#cp $PATH_TO_SDL3/resforkppc.raw .rsrc/$1.APPL
#cp $PATH_TO_SDL3/finfapp.raw .finf/$1.APPL

# This only exists on ancient MacOS X
if [[ -d "/Developer" ]]; then
  cp $1.pef $1.APPL
#xattr -w com.apple.ResourceFork $.APPL $PATH_TO_SDL3/resforkppc.raw
  cp $PATH_TO_SDL3/resforkppc.raw $1.APPL/rsrc
