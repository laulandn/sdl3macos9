...
#ifdef __MWERKS__
#define SDL_Generic_InitTLSData SDL_SYS_InitTLSData
#define SDL_Generic_QuitTLSData SDL_SYS_QuitTLSData
#define SDL_Generic_GetTLSData SDL_SYS_GetTLSData
#define SDL_Generic_SetTLSData SDL_SYS_SetTLSData
#endif
